...
local Window = Fluent:CreateWindow({
	Title = "Heiskso Hub",
	SubTitle = "by @binhandheiskso dsc.gg/heiskso",
	TabWidth = 160,
...
local Tabs = {
	Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://15992619207" }),
	farmsettings = Window:AddTab({ Title = "Farming Settings", Icon = "rbxassetid://15992619207" }),
