...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> siêu phẩm <Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì bắp tươi hub  đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy sử dụng Fluxus để có trải nghiệm tốt!!<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>chào các pro bắp tươi hub đây <Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>bắp tươi hub zui zẻ<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "bắp tươi hub ", HidePremium = false, IntroText = "NightHub Library", SaveConfig = true, ConfigFolder = "bắp tươi hub "})
...
OrionLib:MakeNotification({
	Name = "bắp tươi hub ",
	Content = "bắp tươi hub  Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("[+] bắp tươi hub  is back!")
